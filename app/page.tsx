                ...
                <div className="max-w-6xl mx-auto px-4 py-2 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 bg-white/10 rounded-xl px-3 py-1.5 border border-white/20">
                            <img src="/logo.png" alt="Tom Bear" className="h-8 w-auto object-contain bg-white rounded p-0.5" />
                            <span className="text-white font-bold text-sm hidden sm:block tracking-wide">湯貝爾</span>
                        </div>
